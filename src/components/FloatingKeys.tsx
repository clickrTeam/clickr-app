...
const FloatingKeys: React.FC<FloatingKeysProps> = ({ className }) => {
  const keys = [
    ...
    { letter: 'V', color: 'red', x: -130, y: -70, delay: 4.5, duration: 17 },
    ...
    { letter: 'ctrl', color: 'orange', x: -60, y: -120, delay: 2.8, duration: 20 },
    { letter: 'L', color: 'green', x: 20, y: -130, delay: 0.8, duration: 17 },
    ...
    { letter: 'M', color: 'orange', x: -300, y: -360, delay: 2.2, duration: 18 },
    { letter: 'C', color: 'blue', x: 480, y: -180, delay: 3.2, duration: 16 },
    { letter: 'B', color: 'green', x: -480, y: 180, delay: 1.2, duration: 19 },
    { letter: 'J', color: 'red', x: 420, y: 300, delay: 2.8, duration: 17 },
    { letter: 'L', color: 'yellow', x: -420, y: -300, delay: 3.5, duration: 18 },
    { letter: 'D', color: 'purple', x: 360, y: -330, delay: 1.5, duration: 20 },
    { letter: 'G', color: 'orange', x: -360, y: 330, delay: 2.7, duration: 16 },
    { letter: 'H', color: 'blue', x: 270, y: 270, delay: 3.8, duration: 19 },
    { letter: 'I', color: 'green', x: -270, y: -270, delay: 1.7, duration: 17 },
