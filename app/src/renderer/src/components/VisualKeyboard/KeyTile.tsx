...
export const KeyTile: React.FC<KeyTileProps> = ({ keyModel, onClick, onInspect }) => {
  ...
  // Prefer an override display key if provided by render-time model (displayKey)
  const displayKey = (keyModel as any).displayKey ?? keyModel.key
